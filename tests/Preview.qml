...
ShellRoot {
    component PreviewService: Item {
        ...
        property var state: ({
            ...
            tasks: [
                {task_id: 1, title: "Design the reading corner", elapsed_ms: 2538000, completed: 0, archived: 0, running: true},
                {task_id: 2, title: "Plan meals for the week", elapsed_ms: 0, completed: 0, archived: 0, running: false},
                {task_id: 3, title: "Morning pages", elapsed_ms: 2700000, completed: 1, archived: 0, running: false}],
            week: [
    ...
    PreviewService {
        ...
        Component.onCompleted: {
            ...
            snapshot.tasks = [
                {task_id: 1, title: "Read & take notes", elapsed_ms: 5100000, completed: 1, archived: 0, running: false},
                {task_id: 2, title: "A walk, then a fresh draft", elapsed_ms: 2700000, completed: 1, archived: 0, running: false}]
            state = snapshot
        }
    }
    Window {
